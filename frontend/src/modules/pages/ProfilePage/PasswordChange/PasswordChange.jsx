...
function PasswordChange() {
  ...
  return (
    <div className={styles.profile_page_section}>
      ...
      <table>
        <tbody>
          ...
          <InfoField
            ...
            fieldValue={newPassword1}
            setFieldValue={setNewPassword1}
            fieldType="password"
          />
          <InfoField
            fieldName={"Новый пароль (подтверждение)"}
            fieldValue={newPassword2}
            setFieldValue={setNewPassword2}
            fieldType="password"
          />
        </tbody>
      </table>
      ...
      <button
        onClick={() =>
          changePassword(oldPassword, newPassword1, newPassword2, navigate)
        }
      >
        Сменить пароль
      </button>
