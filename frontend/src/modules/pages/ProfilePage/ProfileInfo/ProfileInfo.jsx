          ...
          <table>
            <tbody>
              ...
              <InfoField
                ...
                fieldValue={username === null ? "" : username}
              ...
              {editing && (
                <InfoField
                  editing={editing}
                  fieldName="Аватар"
                  fieldValue={avatar === null ? "" : avatar}
                  setFieldValue={setAvatarFile}
                  fieldType="image"
                />
              )}
            </tbody>
            ...
            {editing && (
              <>
                ...
                <button
                  onClick={() => {
                    {
                      /*updateUser(user, username, email, setUser, setProfile, setEditing); */
                    }
                    updateProfile(
                      phone,
                      city,
