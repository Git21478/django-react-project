...
function ProductPage() {
  ...
  useEffect(() => {
    appData.categories &&
      productPageProduct.category &&
      setCategory(
        appData.categories.find(
          (category1) => category1.id === productPageProduct.category,
        ),
      );
      ...
      <div className={styles.product_page_wrapper}>
        ...
        <div>
          <div className={styles.product_page_reviews_section}>
            <div>
              <ReviewCreation
                product_id={productPageProductId}
                reviewsOrdering={appData.reviewsOrdering}
            ...
            <div className={styles.product_page_sorting_and_reviews_section}>
              <div>
                <ReviewSortBar
                  setReviewsOrdering={appData.setReviewsOrdering}
                />
              </div>
